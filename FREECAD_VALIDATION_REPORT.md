...
（`BooleanResultVerifier`）が入っており、`contact_placement_probe` の 30 配置・90 演算では
**85 成功・5 拒否・非多様体を返したもの 0** です（2026/08/30 実測。8月28日は
81 / 9。HANDOVER 4-169、4-177、4-182、4-184）。
