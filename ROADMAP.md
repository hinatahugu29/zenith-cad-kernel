...
> | エッジフィレット / 面取り | 直線稜×平面2面、純直円柱の凸円周（フィレット/面取り）、純円錐/円錐台の凸円周、貫通円筒穴口（両操作）に加え、**円筒ボス根元・段付き軸の小径側90度凹円周フィレット**を処理。読んだ15検体で対象稜0は **12→7件**。根元面取り、非円形・非直角根元、円錐円周面取りはまだ対象外（HANDOVER 4-72、4-92〜4-97） |
>
