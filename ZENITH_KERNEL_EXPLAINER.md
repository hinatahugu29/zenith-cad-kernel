...
> | **できないこと** | 実物の `linkrods.step` はまだ切れない（縫合で相手のいない稜が 47／47／40 本。**非多様体は 0**）。**根は測ってあります**——**共有する稜 28 本がどちらの曲面にも乗っておらず**、**ファイルの精度では交わっているかどうかが決まりません**（4-345、4-346）。読んだ `screw.step` の表示メッシュは 16・20・32・48 分割で壊れる |
