...
| **第2段** | **フィレット／面取りの守備範囲**——**4件が「丸める稜があるのに 0本」**（2026/08/30 の測り直し。それまで「7件」としていましたが、うち3件は稜が無いか全部なめらかで **0 で当然**でした） | **H4。いまここ** |
...
| STEP インポーター | **未着手のまま**。読み込みは `import_solids_from_str` が別経路であります |
