...
- **閉じた式が無い組**——**円錐どうし・トーラスどうし・種類の違う 5 組**を、
  ...
  **41 通り測って誤答 0**（2026/09/19。4-479、4-483。
  `curved_pair_identity_probe`）
...
- **トーラスどうしの 3 つの置き方**（横に 2 / 6 / 12）。**うち 2 つは
  9/18 までは返っていました**——**斜めの交わりを通す直しと引き換えに
  失いました**（4-483）。**門が断りの数を数える**ようにしてあるので、
  **次に増えたら赤になります**
...
**トーラスどうしの 3 つの置き方が返りません**（4-481〜4-483）。
