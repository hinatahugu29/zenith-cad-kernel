...
（`BooleanResultVerifier`）が入っており、`contact_placement_probe` の 35 配置・105 演算では
**99 成功・6 拒否・非多様体を返したもの 0** です（2026/08/30 実測。8月28日は
30配置・90演算で 81 / 9。HANDOVER 4-169〜4-197）。拒否の 6 件は**すべて
