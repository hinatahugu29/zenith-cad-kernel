...
**文書バージョン**: v3.3.3 (4-89の接点flap修正と全532テスト完走を反映)
**最終更新日時**: 2026年8月25日  
...
| 何を測ったか | 結果 | 再現コマンド |
| :--- | :--- | :--- |
| ワークスペース全テスト | **98 バイナリ（doctest 込み）/ 532 テスト 100% 合格**（0 failed, 0 ignored） | `cargo test --release --workspace --exclude zenith_py` |
