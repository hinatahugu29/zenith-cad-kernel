...
4. **平歯車の完全閉ソリッド化**（**2026年8月21日 訂正**: 歯形は**インボリュートではありません**。歯1つにつき4点を直線で結んだ多角形の押し出しです。ファイル名と当時の記述が実際の形と違っていました。閉じたソリッドであることと、体積が多角形面積×厚みと 1.5e-11 で一致することは変わりません）:
...
| 平歯車（歯形は多角形。インボリュートではない） | Solid / valid / closed | 1.9e-12 | 2.2e-12 | — |
