...
現在は **22 / 22 の対象で両カーネルが一致**しています。段付き軸根元は体積
1.315e-11、表面積 8.676e-12、断面 1.591e-07で一致します。
...
STEP 経由の相互運用について、**22 対象すべてが OpenCASCADE で Solid・`isValid`・`isClosed` として読まれ、
