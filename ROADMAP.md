...
**和 48 / 差 48 / 積 42 本**。2026/09/05 実測。**別々の稜**で数えた数で、
のべも同数。合計 138 本。**非多様体は 0 本**）。**9/4 に一段進みました**——内側の輪を鎖ごとに
